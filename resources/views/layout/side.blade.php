<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link {{ $ref['title'] == 'Riwayat Perbaikan AC' ? '' : 'collapsed' }}" href="{{ route('history.index') }}">
        ...
        <li class="nav-item">
            <a class="nav-link {{ $ref['title'] == 'Data AC' ? '' : 'collapsed'}}" href="{{ route('daftarAC.index') }}">
        ...
        <li class="nav-item">
            ...
            <ul id="Data-nav"
                class="nav-content collapse {{ $ref['title'] == 'Data Merek AC' ? 'show' : 'collapse' }}"
                data-bs-parent="#sidebar-nav">
                <li>
