...
@section('kontenUser')
                    ...
                    <div class="carousel-caption">
                        <div class="container carousel-content">
                            ...
                            <h1 class="text-white display-1 mb-4 animated fadeInLeft">Sistem Manajemen AC untuk Universitas
                                Janabadra</h1>
                            <p class="mb-4 text-white fs-5 animated fadeInDown">SIMAC dirancang untuk mengelola pemeliharaan
                                AC di Fakultas Teknik Universitas Janabadra, untuk menciptakan lingkungan belajar yang
                                nyaman dan efisien.</p>
                            <button id="openVideo"
                                class="btn btn-primary rounded-pill px-4 py-sm-3 px-sm-5 me-2 animated fadeInLeft">Pelajari
                                Lebih Lanjut</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-5">
                <div class="col-lg-5 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".3s">
                    <div class="h-100 position-relative">
                        ...
                        <div class="position-absolute w-75" style="top: 25%; left: 25%;"></div>
                    </div>
                </div>
                <div class="col-lg-7 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".5s">
                    ...
                    <p>Salah satu fitur unggulan SIMAC adalah kemampuan pemindaian QR Code yang memudahkan akses informasi
                        ...
                        pengelolaan AC yang lebih efisien dan efektif.</p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-lg-6 col-xl-4 wow fadeIn" data-wow-delay=".3s">
                        <div class="blog-item position-relative bg-light rounded">
                            ...
                            <div class="blog-coment px-4 py-2 border bg-primary rounded-bottom mt-3">
                                <a href="" class="text-white"><small>Tekan tombol di atas untuk melihat detail AC
    ...
    <!-- Hidden Video Link -->
    <a href="{{ asset('assetsUsers/img/ac.mp4') }}" class="glightbox" id="videoLink" style="display:none;"></a>
@endsection
