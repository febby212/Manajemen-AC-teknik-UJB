                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between py-3">
                                ...
                                <div class="d-flex justify-content-between gap-3 me-2">
                                    <div>
                                        <a href="{{ route('history.create') }}" type="button" class="btn btn-success">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-1">
                                                    <button type="button" data-bs-target="#showModal{{ $history['id'] }}"
                                                    ...
                                                    <div class="row container-fluid py-3">
                                                        <div class="col-md-12">
                                                            <div>
                                                                ...
                                                                <p class="small ms-4">{{ Str::ucfirst($history['kerusakan']) }}
                                                                </p>
                                                            </div>

                                                            <div>
                                                                <h5 class="card-title">Perbaikan</h5>
                                                                <p class="small ms-4">{{ Str::ucfirst($history['perbaikan']) }}
                                                                </p>
                                                            </div>
                                                            ...
                                                            <div class="row my-1">
                                                                <div class="col-md-5  label ">
                                                                    Kode AC</div>
                                                                <div class="col-md-7">: {{ $history->acDesc->kode_AC }}</div>
                                                            </div>
                                                            ...
                                                            <div class="row my-1">
                                                                <div class="col-md-5 label">
                                                                    Merek AC</div>
                                                                <div class="col-md-7">: {{ $history->acDesc->merekAC->merek }} - {{ $history->acDesc->merekAC->seri }}</div>
                                                            </div>

                                                            <div class="row my-1">
                                                                <div class="col-md-5 label">
                                                                    Teknisi</div>
                                                                <div class="col-md-7">: {{ $history->teknisiPerbaikan->name }} - {{ $history->teknisiPerbaikan->nama_perusahaan }}
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row my-1">
                                                                <div class="col-md-5 label">
                                                                    Biaya Perbaikan</div>
                                                                <div class="col-md-7">: Rp. {{ number_format($history['biaya'], 0, ',', '.') }}</div>
                                                            </div>
                                                            ...
                                                            <div class="row my-1">
                                                                <div class="col-md-5 label">
                                                                    Mengetahui</div>
                                                                <div class="col-md-7">: 
                                                                    {{ isset($history['mengetahui']) ? $history['mengetahui'] : '-' }}</div>
                                                            </div>
                                                            ...
                                                            <div class="row my-1">
                                                                <div class="col-md-5 label">
                                                                    Menyetujui</div>
                                                                <div class="col-md-7">: 
                                                                    {{ isset($history['menyetujui']) ? $history['menyetujui'] : '-' }}</div>
                                                            </div>
                                                            ...
                                                            <div class="row my-1">
                                                                <div class="col-md-5 label">
                                                                    Pembuat Laporan</div>
                                                                <div class="col-md-7">: 
                                                                    {{ Str::ucfirst($history->pembuatLaporan->name) }}</div>
                                                            </div>
