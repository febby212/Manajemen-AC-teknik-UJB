                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>{{ Str::limit($item['gejala'], 30, '...') }}</td>
                                            <td>
                                                        ...
                                                        <form class="needs-validation was-validated"
                                                            ...
                                                            <div class="row g-3">
                                                                ...
                                                                <div class="col-md-12 position-relative">
                                                                    ...
                                                                    <textarea class="form-control" id="validationTooltip02" name="gejala" required="" cols="15" rows="5">{{ $item['gejala'] }}</textarea>
                                                                    <div class="valid-tooltip">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row g-3">
                                                            ...
                                                            <div class="col-md-12 position-relative">
                                                                <label for="validationTooltip02"
                                                                    class="form-label">Gejala</label>
                                                                <textarea class="form-control" id="validationTooltip02" name="gejala" disabled cols="10" rows="5">{{ $item['gejala'] }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
